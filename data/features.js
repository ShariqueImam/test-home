export const featureItems = [
  {
    ...
    description:
      "Compassionate, trained professionals dedicated to delivering exceptional and personalized Caregiving Management",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    description:
      "We prioritize quality care and client happiness, ensuring comfort, safety, and peace of mind always",
  },
  {
    id: 3,
    ...
    description:
      "Enhancing daily living with personalized support for independence, dignity, and well-being",
  },
];
...
export const features5 = [
  {
    title: "Experienced Staff",
    description:
      "Compassionate, trained professionals dedicated to delivering exceptional and personalized home care.",
    svgPath:
  ...
  },
  {
    ...
    description:
      "Dedicated, compassionate caregivers providing personalized assistance to ensure comfort and a better quality of life",
    svgPath:
