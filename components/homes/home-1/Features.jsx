            ...
            <>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-descr">
                    Easy, hassle-free home care solutions tailored to your needs
              ...
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-descr">
                    Reliable, transparent services with a commitment to
                    delivering exceptional care and support
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
              ...
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Experience</div>
                  <div className="features-descr">
                    Skilled professionals providing expert, personalized home
                    care with years of experience and dedication
                  </div>
                </div>
              </SwiperSlide>
            </>
