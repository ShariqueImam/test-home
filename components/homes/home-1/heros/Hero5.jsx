              ...
              <div className="col-md-10 offset-md-1 mb-20 mb-sm-0">
                ...
                <h1 className="hs-title-12 mb-50 mb-sm-30">
                  <span className="wow charsAnimIn" data-splitting="chars">
                    <AnimatedText text="Compassionate Care Right at your Home" />
                  </span>
                </h1>

                <div className="local-scroll wch-unset wow fadeInUp animated">
                  <a
                    href="#about"
                  ...
                  >
                    <span className="btn-animate-y">
                      <span className="btn-animate-y-1">Get Care Now</span>
                      <span className="btn-animate-y-2" aria-hidden="true">
                        Get Care Now
                      </span>
                    </span>
